...
import { guardEmptyString } from '../invariants/string/empty-string';
...
type UniqueIdentifierFailure = {
  readonly _tag: 'UniqueIdentifierFailure';
  readonly cause: DomainFailure;
  readonly name: string;
} & DomainFailure;

// eslint-disable-next-line sonarjs/no-redeclare
const UniqueIdentifierFailure =
  (name: string) =>
    (cause: DomainFailure): UniqueIdentifierFailure =>
      domainFailure({
        _tag: 'UniqueIdentifierFailure',
        cause,
        name,
      });
