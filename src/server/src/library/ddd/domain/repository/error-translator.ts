 ...
 */
export type Translation<Failure> =
  | {
    /**
     * ---
 ...
 * ---
 * An `ErrorTranslator` inspects **raw infrastructure errors**
 ...
 */
export interface ErrorTranslator<Failures> {
  /**
   * ---
   ...
   */
  translate(error: unknown): Translation<Failures>;
  /**
   * ---
   * Attempts to translate an infrastructure error into a domain failure.
   * ---
