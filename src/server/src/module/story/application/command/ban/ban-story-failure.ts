 ...
 * the execution of the BanStory use case.
 * ---
...
/**
 * ---
 * Factory for creating {@link BanStoryFailure}.
 *
...
export const BanStoryFailure =
  (name: string) =>
    (cause: InfrastructureFailure | DomainFailure): BanStoryFailure =>
      applicationFailure({
        _tag: 'BanStoryFailure',
        cause,
        name,
      });
