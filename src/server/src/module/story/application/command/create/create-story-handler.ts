 ...
 */
export class CreateStoryCommandHandler implements CommandHandler<CreateStoryCommand, string, CreateStoryFailure> {
  /**
   * ---
   ...
   */
  handle(command: CreateStoryCommand, environment: TransactionEnvironment): Task<string, CreateStoryFailure> {
