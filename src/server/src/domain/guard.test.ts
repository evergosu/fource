...
describe('guard', () => {
  ...
  describe('Guard.againstNullOrUndefined()', () => {
    it('should fail on null', () => {
      ...
      expect(result.getError()).toBeInstanceOf(NullOrUndefinedError);
    });
  ...
  describe('Guard.againstNotString()', () => {
    it('should fail on not a string', () => {
      ...
      expect(result.getError()).toBeInstanceOf(StringError);
    });
  ...
  describe('Guard.againstBlankString()', () => {
    ...
    it('should fail on empty string', () => {
      ...
      expect(result.getError()).toBeInstanceOf(BlankStringError);
    });
  ...
  describe('Guard.againstMinimumLength()', () => {
    ...
    it('should fail on short string', () => {
      ...
      expect(result.getError()).toBeInstanceOf(MinimumLengthNotMetError);
    });
  ...
  describe('Guard.againstMaximumLength()', () => {
    ...
    it('should fail on long string', () => {
      ...
      expect(result.getError()).toBeInstanceOf(MaximumLengthExceededError);
    });
  ...
  describe('Guard.againstInvalidFormat()', () => {
    ...
    it('should fail on regex mismatch', () => {
      ...
      expect(result.getError()).toBeInstanceOf(InvalidFormatError);
    });
  ...
  describe('Guard.againstInvalidEmail()', () => {
    ...
    it('should fail on invalid email', () => {
      ...
      expect(result.getError()).toBeInstanceOf(InvalidEmailError);
    });
  ...
  describe('Guard.againstDateInPast()', () => {
    it('should fail on not a date', () => {
      ...
      expect(result.getError()).toBeInstanceOf(DateInPastError);
    });
  ...
  describe('Guard.againstOutOfRange()', () => {
    it('should fail on not a number', () => {
      ...
      expect(result.getError()).toBeInstanceOf(OutOfRangeError);
    });
